...
## 未完了タスク（2026-07-03夜時点）

1. ~~岩手・山形・青森・香川スクレイパーの実サイト通し実行~~ → 完了（岩手857件・山形1,729件・青森98件・香川723件をマージ済み）
...
6. 青森: 個別詳細ページを持たない神社（一覧に名前・住所のみ掲載）の追加抽出（香川方式）。現状98件だが一覧ページにはもっと多くの神社が記載されている
